...
const DATABASE_PATH =
  ...
  path.join(process.env.RAILWAY_VOLUME_MOUNT_PATH || path.join(__dirname, 'data'), 'big-jims-pickels.sqlite');
const SESSION_SECRET = process.env.SESSION_SECRET || 'big-jims-development-session-secret';
const ADMIN_USERNAME = process.env.ADMIN_USERNAME || 'admin';
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || 'BIGBOY';
